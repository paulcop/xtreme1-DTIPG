...
const groupPointscount = ref(editor.pc.groupPointscount); // Initialiser avec la valeur actuelle ou 0
...
const addNewLineGroup = () => {
  editor.pc.groupPointscount = editor.pc.groupPointscount + 1;
  groupPointscount.value = editor.pc.groupPointscount;
